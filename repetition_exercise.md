...
- es sollen Datenobjekte für alle neuen Eigenschaften des abgebildeten ER-Modells für 2 Spieler, 2 Kämpfer, 2 Nahkampfwaffen, 2 Fernkampfwaffen und 10 Würfel deklariert werden
...
Das Spiel soll aus mehreren Runden bestehen und solange dauern, bis ein Spieler keine Kämpfer mehr hat. In jeder Runde sollen sich die Kämpfer der Spieler gegenseitig abwechselnd angreifen können. Dabei soll jeder Spieler entscheiden können, ob der eigene Kämpfer einen Fernkampfangriff oder einen Nahkampfangriff ausführen soll. "Stirbt" einer Kämpfer (LP <= 0), soll das Spiel enden.
